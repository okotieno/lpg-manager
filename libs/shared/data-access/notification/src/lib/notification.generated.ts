...
export type IGetAuthenticatedUserNotificationStatsQuery = { authenticatedUserNotificationStats?: { unread: number, total: number } | null };
...
export type INotificationCreatedTrackSubscription = { notificationCreated?: { notification?: { id: string, title: string, isRead: boolean, description: string, createdAt: string } | null } | null };
