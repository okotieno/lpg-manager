...
export type IGetUserByIdQuery = { user?: { phone?: string | null, id: string, email: string, firstName: string, lastName: string, profilePhotoLink?: string | null, createdAt?: string | null, roles?: Array<{ id: string, role: { id: string, name: string }, station: { id: string, name: string, type: Types.IStationType } } | null> | null } | null };
